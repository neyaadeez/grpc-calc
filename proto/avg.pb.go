...
func (x *AvgNRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AvgNRequest) ProtoMessage() {}

func (x *AvgNRequest) ProtoReflect() protoreflect.Message {
	mi := &file_avg_proto_msgTypes[0]
...
// Deprecated: Use AvgNRequest.ProtoReflect.Descriptor instead.
func (*AvgNRequest) Descriptor() ([]byte, []int) {
	return file_avg_proto_rawDescGZIP(), []int{0}
}

func (x *AvgNRequest) GetNum() int32 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *AvgResponse) GetRes() int32 {
	if x != nil {
		return x.Res
	}
	return 0
...
var file_avg_proto_rawDesc = []byte{
	0x0a, 0x09, 0x61, 0x76, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x61, 0x6c,
	0x63, 0x22, 0x1f, 0x0a, 0x0b, 0x41, 0x76, 0x67, 0x4e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x72, 0x65, 0x73, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x6e, 0x65, 0x79, 0x61, 0x61, 0x64, 0x65, 0x65, 0x7a, 0x2f, 0x67, 0x72, 0x70, 0x63,
	0x2d, 0x63, 0x61, 0x6c, 0x63, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_avg_proto_goTypes = []interface{}{
	(*AvgNRequest)(nil), // 0: calc.AvgNRequest
